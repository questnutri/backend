	...
	paths: {
		'/auth/password/reset/patient/send': {
			post: {
				...
				description:
          'This route sends a token to the patient to reset the password',
				tags: ['Auth'],
				security: [
					{
						bearerAuth: [],
				...
				parameters: [
					{
						...
						in: 'header',
						description:
              'Id to perform the administrator search in the database',
						required: true,
					},
				],
				security: [
				...
				parameters: [
					{
						...
						in: 'path',
						description:
              'Id to perform the nutritionist search in the database',
						required: true,
					},
				],
				responses: {
